...
public class UrlClient {
	...
	public static String doGet(String url) throws IOException{
		return doGet(url, "UTF-8",3000, 15000,null);
	}
	
	public static String doGet(String url, String charset, int connectTimeout, int readTimeout, Map<String, String> headerMap) throws IOException {
		HttpURLConnection conn = null;
		OutputStream out = null;
		String rsp = null;
		try {
			String ctype = "application/x-www-form-urlencoded;charset="+charset;
			conn = getConnection(new URL(url), "GET", ctype, headerMap);
	...
	public static String doPost(String url, Map<String, String> params, Map<String, File> fileParams,
		...
		if(fileParams != null && fileParams.size() > 0){
			return doPostWithFile(url, params, fileParams, connectTimeout, readTimeout, headerMap);
		}else{
			return doPost(url, params, connectTimeout, readTimeout, headerMap);
		}
	}
	...
	public static String doPostWithFile(String url, Map<String, String> params, Map<String, File> fileParams, int connectTimeout, int readTimeout, Map<String, String> headerMap) throws IOException {
